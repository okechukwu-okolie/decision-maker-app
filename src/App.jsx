...
function App() {
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <img
            ...
            alt="Priority App"
            className="mx-auto mb-4 w-80 h-auto md:w-96 animate-pulse"
          />
  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
        ...
        <header className="flex items-center justify-between px-6 py-4 relative">
          <div className="flex items-center gap-4">
            ...
            <nav className="hidden md:flex gap-2">
              <button
                className="px-3 py-2 rounded-lg bg-black text-white dark:text:slate-900"
                onClick={() => {
                  setRoute("app");
          ...
          {mobileMenuOpen && (
            <div className="absolute right-4 top-16 border border-white/6 rounded-lg p-3 w-44 z-40 md:hidden bg-white text-black dark:bg-slate-600/60 dark:text-slate-500">
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 flex-1 overflow-auto">
        <main>
